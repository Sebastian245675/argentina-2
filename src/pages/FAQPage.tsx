              ...
              <div className="lg:col-span-1 pt-0">
                <div className="bg-white rounded-3xl p-8 w-full flex flex-col items-center text-center border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)] sticky top-24">
                  ...
                  <a
                    ...
                    className="flex flex-col items-center hover:scale-105 transition-transform duration-300 group"
                  >
                    <div className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg group-hover:shadow-[#25D366]/40 mb-3 border-4 border-white mb-2 relative">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512"
                        className="w-8 h-8 text-white ml-0.5 mt-0.5"
                        fill="currentColor"
                      >
                    ...
                    <span className="font-extrabold text-lg text-gray-900 uppercase tracking-wide">¡Llamanos!</span>
                  </a>
                </div>
              </div>
            </div>
