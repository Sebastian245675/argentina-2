        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 relative">
            ...
            <div>
              ...
              <ul className="space-y-3 text-[13px] text-gray-300">
                <li><Link to="/categoria/Fragancias" className="hover:text-white transition-colors">Fragancias</Link></li>
                <li><Link to="/categoria/Decants" className="hover:text-white transition-colors">Decants</Link></li>
                <li><Link to="/categoria/Combos%20Decants" className="hover:text-white transition-colors">Combos Decants</Link></li>
                <li><Link to="/categoria/Marcas" className="hover:text-white transition-colors">Marcas</Link></li>
                <li><Link to="/categoria/Beauty" className="hover:text-white transition-colors">Beauty</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-4 text-[13px] text-gray-300">
                ...
                <li>
                  <a href="mailto:visfumarg@gmail.com" className="hover:text-white transition-colors block">
                    visfumarg@gmail.com
                  </a>
                </li>
              </ul>
            ...
            <div className="flex gap-4 md:justify-end">
              <a href="https://www.instagram.com/visfum?igsh=b3c1ZzIyOWw2MG95" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@visfumarg" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors" aria-label="TikTok">
          ...
          <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-[11px] text-gray-400 text-center md:text-left">
              Copyright VISFUM - {new Date().getFullYear()}. Todos los derechos reservados. Defensa de las y los consumidores. Para reclamos <a href="#" className="underline hover:text-white">ingresá acá</a>.
            </p>
