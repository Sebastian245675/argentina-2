            ...
            <ul className="space-y-4">
              <li>
                <a href="https://wa.me/541126711308" target="_blank" rel="noopener noreferrer" className="flex flex-col group py-1">
                  <span className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mb-1 group-hover:text-blue-600 transition-colors">WhatsApp</span>
                  <span className="text-[13px] font-black text-gray-900">11 2671-1308</span>
                </a>
              </li>
              <li>
