...
export const FloatingActionButtons = () => {
    ...
    return (
        <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3">
            ...
            {/* Botón WhatsApp - Real Logo */}
            <a
                href={whatsappUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full shadow-xl flex items-center justify-center transition-all hover:scale-110 w-[52px] h-[52px] border-2 border-white/10"
